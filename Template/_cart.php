				...
				<div class="row border-top py-3 mt-3">
						...
						<div class="qty d-flex pt-2">
							<div class="d-flex font-rubik w-25">
								...
								<input data-id="pro1" type="text"
									class="qty_input border px-2 bg-light w-100" disabled value="1"
									placeholder="1" />
					...
					<div class="col-sm-2 text-right">
						<div class="font-size-20 text-danger font-baloo">
							$ <span class="product_price"><?php echo $item1['item_price']?></span>
						</div>
					</div>
				</div>
				<?php
				...
				<div class="sub-total border text-center mt-2">
					...
					<div class="border-top py-4">
						<h5 class="font-rubik font-size-20">
							Subtotal (<?php echo count($subTotal)?> items): &nbsp; <span
